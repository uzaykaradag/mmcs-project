import random
def random_limit_categories(category_list, selection_size, lower_bound, upper_bound):
    ...
    ratios = [random.uniform(lower_bound, upper_bound) for sc in selected_categories]
